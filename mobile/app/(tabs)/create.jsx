...
export default function Create() {
  ...
  const pickImage = async () =>{
    try {
      //request if permission is needed
      if(Platform.OS !== "web"){
      ...
      const result = await ImagePicker.launchImageLibraryAsync({
        ...
        allowsEditing: true,
        aspect: [4, 3],
        quality: 0.5, //lower for smaller base64 
        base64: true
      });
  ...
  const handleSubmit = async () =>{
    ...
    try {
      ...
      if(!response.ok) throw new Error(data.message || "Something went wrong in saving books")
  ...
  return (
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container} style={styles.scrollViewStyle}>
